# Facial-Emotion-Detection-using-OpenCV-and-Deepface
...
## Usage
### Initial steps:
- Git clone this repository Run: `git clone https://github.com/Parameshbaba5/Facial-Emotion-Detection-using-OpenCV-and-Deepface.git`
